    ...
    for bamfile in bamfiles:
        ...
        for read in bam:
            if is_first_read:
                ...
                net[ref2][ref1] += 1
                if num % 10000000 == 0:
                    print "parsed {0} read pairs from file {1}, {2} filtered out as duplicates".format(num, bamfile, num_dupes)
            else:
            	is_first_read = True
...
def write_reads_on_contig(net, outfile2):
...
def main():
	...
	net, ref_lens = parse_bam_to_link_counts(bams)
